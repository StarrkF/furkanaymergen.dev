...
<template>
  <section id="tools" class="min-h-screen px-10 bg-base-100 md:px-32 lg:px-60">
    ...
    <h3 data-aos="fade-down"
      class="w-full mx-auto my-20 text-2xl text-center md:text-4xl font-oswald md:w-1/2 md:my-20">
      {{ $t('tool.summary') }}</h3>
    <swiper class="w-full mx-auto" data-aos="fade-down" :grabCursor="true" :modules="[SwiperAutoplay, SwiperFreeMode]"
      :slidesPerView=2 :free-mode="true" :space-between=25 :loop="true" :breakpoints="breakpoints" :autoplay="autoplay">
