import { resolveDirective, mergeProps, withCtx, createBlock, openBlock, createVNode, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot, ssrRenderList, ssrInterpolate, ssrGetDirectiveProps } from 'vue/server-renderer';
import { _ as _export_sfc, f as useColorMode, g as useI18n } from './server.mjs';
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></ul></div><div class="navbar-end"><div class="flex items-center gap-2"><label class="swap text-primary"><input type="checkbox"><div class="swap-off flex items-center gap-1"><div class="w-10 hover:cursor-pointer">EN</div></div><div class="swap-on flex items-center gap-1"><div class="w-10 hover:cursor-pointer">TR</div></div></label><div class="dropdown dropdown-end dropdown-"><label tabindex="0" class="m-1 transition duration-200 hover:cursor-pointer hover:text-primary"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block w-7 h-7 stroke-current text-primary hover:text-accent transition duration-300"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg></label><ul tabindex="0" class="dropdown-content z-1 menu p-2 shadow-lg bg-base-100 rounded-box w-52 glass"><!--[-->`);
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<a${ssrRenderAttrs(mergeProps({
        ...
        title: __props.title,
        target: "_blank",
        class: "flex items-center justify-center w-5 h-5 fill-base-content rounded-full sm:w-8 sm:h-8 hover:fill-primary transition duration-300 hover:scale-110"
      }, _attrs))}>`);
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  const _component_SocialIcon = _sfc_main$2;
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "footer md:footer-horizontal footer-center py-4 px-8 z-9999 backdrop-blur-md bg-opacity-40 fixed bottom-0" }, _attrs))}><div class="flex justify-between w-full md:max-w-md lg:max-w-2xl">`);
...
//# sourceMappingURL=default-IAGCz0O8.mjs.map
